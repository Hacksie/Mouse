...
namespace HackedDesign
{
    ...
    public class GoapAgent : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            gPlanner = GoapFactory.Instance.CreatePlanner();
        }
        ...
        void SetupBeliefs()
        {
            ...
            factory.AddSensorBelief("PlayerInMeleeRange", meleeSensor);
            factory.AddBelief("ShootingPlayer", () => false); // Player can always be attacked, this will never become true
            factory.AddBelief("MeleeingPlayer", () => false); // Player can always be attacked, this will never become true
        }
        ...
        void SetupActions()
        {
            ...
            actions.Add(new AgentAction.Builder("ChasePlayer")
                .WithStrategy(new MoveStrategy(() => beliefs["PlayerInChaseRange"].Location))
            ...
            actions.Add(new AgentAction.Builder("AttackPlayer")
                ...
                .AddEffect(beliefs["ShootingPlayer"])
                .Build());

            
            actions.Add(new AgentAction.Builder("MeleePlayer")
                .WithStrategy(new MeleeStrategy())
                .AddPrecondition(beliefs["PlayerInMeleeRange"])
                .AddEffect(beliefs["MeleeingPlayer"])
                .Build());
        }
        ...
        void SetupGoals()
        {
            ...
            goals.Add(new AgentGoal.Builder("RangedAttack")
                .WithPriority(3)
                .WithDesiredEffect(beliefs["ShootingPlayer"])
                .Build());

            
            goals.Add(new AgentGoal.Builder("Destroy")
                            .WithPriority(5)
                            .WithDesiredEffect(beliefs["MeleeingPlayer"])
                            .Build());
        }
