...
namespace HackedDesign
{
    ...
    public class MeleeStrategy : IActionStrategy
    {
        public bool CanPerform => true; // Agent can always attack
        public bool Complete { get; private set; }
    ...
    public class MoveStrategy : IActionStrategy
    {
        ...
        public bool Complete => false; // agent.remainingDistance <= 2f && !agent.pathPending;

        public MoveStrategy(Func<Vector3> destination)
        {
            //this.agent = agent;
